...
if(isset($image)){
    ...
    if ($select_image->rowCount() > 0 AND $image != '') {
        ...
        $insert_products = $conn->prepare("INSERT INTO `products`(id,seller_id,name,price,image,stock,product_detail,status)VALUES(?,?,?,?,?,?,?,?)");
        $insert_products->execute([$id, $seller_id, $name, $price, $image, $stock, $description, $status]);
      ...
      <div class="form-container">
        <form action="" method="post" enctype="multipart/form-data" class="register">
            ...
            <div class="input-field">
                ...
                <input type="text" name="stock" maxlength="10" min="0" max="9999999999" 
